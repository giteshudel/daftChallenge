...
pgm.render()
plt.title("The 1747 Understanding (Correct but Incomplete)", fontsize=12, fontweight='bold', pad=15)
...
pgm.add_node("acid", "Acid", 1, 1, aspect = 3, scale = 1.1,
             plot_params={
                 'facecolor': '#FFB6C6',  # Light pink
                 'edgecolor': '#DC143C',  # Crimson
                 'linewidth': 2,
                 'alpha': 0.8,
             })
...
pgm.add_node("bacteria", "Bacteria\nDeath", 2.50, -0.5, aspect = 3, scale = 1.1,
             plot_params={
                 'facecolor': '#D3D3D3',  # Gray to indicate wrong belief
                 'edgecolor': '#696969',  # Dim gray
                 'linewidth': 2,
                 'alpha': 0.8,
             })
...
# Render the DAG
pgm.render()
plt.title("The Misguided Belief: Why the Cure Was Lost", fontsize=12, fontweight='bold', pad=15)
```
